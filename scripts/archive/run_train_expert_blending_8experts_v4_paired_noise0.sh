...
#
# Usage: bash scripts/run_train_expert_blending_8experts_v4_paired_noise0.sh
set -euo pipefail

SCRIPT_ROOT="$(cd "$(dirname "$0")/.." && pwd)"
LOGDIR="${SCRIPT_ROOT}/logs/expert_blending_8experts_v4_paired_noise0"
LOG_FILE="/tmp/train_expert_blending_8experts_v4_paired_noise0.log"
