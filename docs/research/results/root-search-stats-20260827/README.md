...
> 2026-08-28追記: 重複なし1,000局面の追加splitで固定bestmoveが`-2.70`ポイント、
> McNemar `p=0.038878`となり、既存独立testの非再現と合わせて仮説を棄却へ更新した。
> 詳細は[24時間 深掘り検証](../deep-validation-24h-20260828/README.md)を参照。
