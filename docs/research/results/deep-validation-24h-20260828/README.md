...
> 2026-09-20監査: 以下は当時の集計と判定を保存したもの。ペア単位で再解析しても
> 14,000局の差は`+6.68 Elo [+1.36,+12.00]`だった。一方、対局履歴・キャッシュ条件、
> 教師との少数重複、結果を見た後の拡張判断について限定がある。
> [研究レビュー](../research-review-20260920/README.md)を併読する。
