...
テスト局面 1,000 件に対して、Floodgate 棋譜の最善手との一致率を計測した（探索ノード数 100 万）。ベースラインNNUEは、たぬきチームが提供する局面データで標準NNUEを学習したもの。Expert Blendingは、当該モデルを初期値として学習した。

| システム | 最善手一致率 |
|---------|------------:|
| Expert Blending | 63.3% |
| ベースライン NNUE | 64.4% |
| Suisho5 | 60.2% |
